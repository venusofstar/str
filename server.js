...
function startStream(ep) {
  ...
  console.log(`🚀 Starting VOD stream: ${ep}`);
  ...
  const ffmpegArgs = [
    ...
    // 🔥 copy video (fast) + encode audio
    "-c:v", "copy",
    "-c:a", "aac",
    "-b:a", "128k",

    // =====================================
    // ✅ VOD MODE (IMPORTANT FIX)
    // =====================================
    "-f", "hls",
    "-hls_time", "4",
    "-hls_list_size", "0",
...
// ================================
// 🚀 LAZY START (BETTER THAN AUTO ALL)
// ================================
...
// ================================
app.get("/", (req, res) => {
  res.send("🚀 VOD IPTV Server Running (FIXED MODE)");
});
